...
class MemapParser(object):
    ...
    def generate_bars(self, file_desc, device_name):
        ...
        rom = int(cmsis_part['memory']['IROM1']['size'], 0)
        ram = int(cmsis_part['memory']['IRAM1']['size'], 0)
        ...
        usage = "Text {} BSS {} Data {}".format(unit(text), unit(bss), unit(data))
        avail = "ROM {} RAM {}".format(unit(rom), unit(ram))
